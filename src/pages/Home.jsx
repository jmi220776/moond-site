...
// ============================================================
// MOOND — Page d'accueil
// 1. Vidéo intro (11s) → 2. Landing MOOND → 3. Trois portes
// La porte "La Famille" navigue vers /famille
// ============================================================
...
export default function Home() {
  ...
  // Bascule son vidéo → audio quand on quitte la vidéo
  useEffect(() => {
    const v = videoRef.current;
    const a = audioRef.current;
    if (!v || !a) return;
  ...
  return (
    <>
      ...
      <div className={`screen-video ${step !== 'video' ? 'fading' : ''}`}>
        ...
        {showSkip && (
          <button className="skip-btn" onClick={goToLanding}>Passer →</button>
        )}
      </div>
      ...
      <div className={`screen-landing ${step === 'landing' ? 'visible' : ''} ${step === 'portes' ? 'fading' : ''}`}>
        ...
        <h1 className="moond-title">
          M<span className="o1">O</span><span className="o2">O</span>ND
        </h1>

        <p className="landing-subtitle">
          <em>certains souvenirs <span className="accent">résistent</span></em>
        </p>

        <button className="enter-btn" onClick={goToPortes}>ENTRER</button>
      ...
      <div className={`screen-portes ${step === 'portes' ? 'visible' : ''}`}>
        <div className="portes-header">
          <h2 className="portes-title">
            <em>Choisissez ce que<br />vous voulez découvrir.</em>
          </h2>
          <p className="portes-subtitle"><em>Trois portes. Trois vérités.</em></p>
        </div>

        <div className="portes-container">
          {/* PORTE 1 — LA FAMILLE → navigue vers /famille */}
          <a className="porte porte-famille" onClick={() => navigate('/famille')} style={{cursor:'pointer'}}>
            ...
            <div className="porte-content">
              ...
              <div className="porte-desc">
                <em>Vêtements, personnages<br />et quotidien imparfait.</em>
              </div>
            </div>
            <div className="porte-arrow">→</div>
          </a>

          {/* PORTE 2 — FRAGMENTS (inactive) */}
          <a className="porte porte-fragments" onClick={(e) => e.preventDefault()} style={{cursor:'pointer'}}>
            <div className="porte-icon">
            ...
            <div className="porte-content">
              ...
              <div className="porte-desc">
                <em>Archives VHS, extraits<br />retrouvés et anomalies.</em>
              </div>
            </div>
            <div className="porte-arrow">→</div>
          </a>

          {/* PORTE 3 — MANIFESTE (inactive) */}
          <a className="porte porte-manifeste" onClick={(e) => e.preventDefault()} style={{cursor:'pointer'}}>
            <div className="porte-icon">
            ...
            <div className="porte-content">
              ...
              <div className="porte-desc">
                <em>Nos intentions. Notre vision.<br />Pourquoi MOOND existe.</em>
              </div>
            </div>
            <div className="porte-arrow">→</div>
          </a>
        ...
        <div className="portes-footer">
          <p>
            <em>Chaque choix vous mènera plus loin.<br />
            Ou ramènera quelque chose à la surface.</em>
          </p>
        </div>
      </div>
...
.screen-video.fading { opacity: 0; pointer-events: none; }
.screen-video video {
  width: 100%;
  height: 100%;
  object-fit: contain;
...
.start-btn:hover { background: var(--terracotta); letter-spacing: 0.5em; }
...
.enter-btn:hover { color: var(--cream); letter-spacing: 0.5em; }
...
.portes-header { text-align: center; margin-bottom: 56px; max-width: 600px; }
.portes-title {
  font-family: 'Cormorant Garamond', serif;
  font-style: italic;
  font-weight: 400;
...
.porte-icon svg { width: 64px; height: 64px; transition: transform 0.4s ease; }
.porte:hover .porte-icon svg { transform: scale(1.05); }

.porte-content { display: flex; flex-direction: column; justify-content: center; gap: 8px; }
.porte-title {
  font-family: 'Cinzel', serif;
  font-weight: 500;
...
.portes-footer { margin-top: 64px; text-align: center; max-width: 480px; padding: 0 24px; }
.portes-footer p {
  font-family: 'Cormorant Garamond', serif;
  font-style: italic;
  font-weight: 300;
...
@media (max-width: 640px) {
  ...
  .porte-icon { height: 60px; padding-right: 14px; margin-right: 14px; }
